...
double calibrationCameraVelodyneChessboardObjectiveFunc(const std::vector<double> &x, std::vector<double> &grad, void *data)
{
    ...
    rotation = Eigen::AngleAxisd(x[2], Eigen::Vector3d::UnitZ()) * Eigen::AngleAxisd(x[1], Eigen::Vector3d::UnitY()) * Eigen::AngleAxisd(x[0], Eigen::Vector3d::UnitX());
...
bool CalibrateCameraVelodyneChessboardBase::calibrateSensor()
{
    ...
    Eigen::Matrix3d rotation;
    rotation = Eigen::AngleAxisd(xx[2], Eigen::Vector3d::UnitZ()) * Eigen::AngleAxisd(xx[1], Eigen::Vector3d::UnitY()) * Eigen::AngleAxisd(xx[0], Eigen::Vector3d::UnitX());
